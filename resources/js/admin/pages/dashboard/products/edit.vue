      ...
      return {
        ...
        init: function () {
          ...
          this.on("sending", function(file, xhr, formData) {
            ...
            formData.append('model_id', self.id)
          });
          ...
          self.form.images.forEach(image => {
            ...
            this.emit("thumbnail", mockFile, image.uri);
  ...
  async mounted () {
    ...
    await getProduct(this.id)
      .then(product => {
        ...
        let en = product.translations.find(e => e.locale === 'en')

        this.form.ru.name = ru.name
        this.form.ru.description = ru.description

        this.form.en.name = en.name
        this.form.en.description = en.description
